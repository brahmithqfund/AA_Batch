...
public class WOR_CCK_2tendertypes extends AA_PDL {

	
	

	
	public static void WOR_CCK_2tendertypes_DiffNumbers(String SSN,String FileName) throws Exception{
	...
	/*			String Refno1 = TestData.getCellData(sheetName,"Refno1",row);
				...
				driver.switchTo().frame("mainFrame");
				driver.switchTo().frame("main");
				driver.findElement(By.name("transactionList")).sendKeys("WriteOff Recovery");
	...
	public static void WOR_CCK_2tendertypes_SameNumbers(String SSN,String FileName) throws Exception{
