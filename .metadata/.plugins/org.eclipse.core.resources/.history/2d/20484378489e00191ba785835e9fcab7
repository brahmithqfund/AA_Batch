	...
	public static void NewLoan_ILP(String SSN, String FileName, String NegAmt) throws Exception {
		...
		for (int row = 2; row <= lastrow; row++) {
			...
			if (SSN.equals(RegSSN)) {
				 ...
				 * 
				 * if(ESign_CollateralType.equals("ACH")) { //*[@id="termSel1"]
				 * 
				 * driver.findElement(By.xpath(
				 * "//*[@id='tableWid1']/tbody/tr[1]/td/b/input")).click();
				 * test.log(LogStatus.PASS, "ProductName is selected as "
				 * +ProductName);
				 * 
				 * }
				 * 
				 * if(ESign_CollateralType.equals("CASH")) { //*[@id="termSel1"]
				 * //driver.findElement(By.xpath("//*[@id='termSel1']")).click()
				 * ; //*[@id="tableWid1"]/tbody/tr[1]/td/b
				 * //*[@id="tableWid2"]/tbody/tr[1]/td/b
				 * driver.findElement(By.xpath(
				 * "//*[@id='tableWid2']/tbody/tr[1]/td/b/input")).click();
				 * test.log(LogStatus.PASS, "ProductName is selected as "
				 * +ProductName); } }
				 */
						...
						if (!(winHandle1.equals(Parent_Window1))) {
							...
							if (element.isDisplayed()) {
								...
								builder.doubleClick()
										...
										.sendKeys(element, Keys.BACK_SPACE).sendKeys(element, Keys.BACK_SPACE)
										.sendKeys(element, Keys.BACK_SPACE).sendKeys(element, Keys.BACK_SPACE)
										.sendKeys(element, Keys.BACK_SPACE).sendKeys(element, Keys.BACK_SPACE)
										.sendKeys(element, Keys.BACK_SPACE).build().perform();
							}
							...
							driver.findElement(By.name("requestBean.siilBean.collateralType"))
									.sendKeys(ESign_CollateralType);
							test.log(LogStatus.PASS, "Collateral type is selected as ::" + ESign_CollateralType);
							Actions builder = new Actions(driver);
							builder.doubleClick().sendKeys(element, Keys.ARROW_DOWN).sendKeys(element, Keys.ARROW_DOWN)
									.sendKeys(element, Keys.ARROW_DOWN).sendKeys(element, Keys.ARROW_DOWN)
							...
							driver.findElement(By
									.xpath("/html/body/form/table/tbody/tr[6]/td/table/tbody/tr/td[2]/table/tbody/tr[14]/td/input"))
									.click();
				...
				/*
				 * //*[@id="errorMessage"]/form[1]/table/tbody/tr[4]/td/table[1]
				 * /tbody/tr[5]/td[2]/input System.out.println(NumofInst); int
				 * installments = Integer.parseInt(NumofInst); for(int
				 * i=0;i<installments;i++) { Random rand = new Random(); int
				 * rand1 = rand.nextInt(100000); String chknum =
				...
				// driver.findElement(By.xpath("//input[ @value='Yes' and
				// @type='button' ]")).click();
